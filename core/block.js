...
const { Block } = require("../typings/blockly");
...
Blockly.Block = function(workspace, prototypeName, opt_id) {
  ...
  this.comment = null;
	...
	/**
	 * A string representing the name of a variable
	 * that the block is either declaring, or is 
	 * another block streaming a variable name.
	 * 
	 * @type {string|Blockly.Block.string}
	 * @current June 2020
	 */
  ...
  /**
   * A string representing a pointer
   * 
   * @type {string|Blockly.Block.string}
   * @current July 2020
   */
  ...
  /**
   * An integer representing a ptr level
   * 
   * @type {integer|Blockly.Block.integer}
   * @current July 2020
   */
  this.ptrLevel_ = 0;

  /**
   * A bool to represent if this is a reference
   * 
  ...
  /**
   * A bool to represent if this is null
   * 
   * @type {bool|Blockly.Block.bool}
   * @current July 2020
   */
  ...
  /**
   * A boolean representing a const
   * 
   * @type {bool|Blockly.Block.bool}
   * @current July 2020
   */
   ...
   * @type {boolean|Blockly.Block.dataStr}
   * @current March 2020
   */
	this.dataStr = {
		isVar: false,
